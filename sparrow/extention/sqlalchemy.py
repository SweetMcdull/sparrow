...
from sparrow.core.exceptions.base import NotFound
...
class Record:
    ...
    def dataset(self):
        ...
        row = _reduce_datetime(self.values())
        data.append(row)
...
class RecordCollection:
    ...
    def dataset(self):
        ...
        for row in self.all():
            row = _reduce_datetime(row.values())
            data.append(row)
...
class Database(SQLAlchemy):
    ...
    def close(self, force=False):
        ...
        operation to complete. This may be overridden by setting force=True, but
...
def _reduce_datetime(row):
    """Receives a row, converts datetime to string."""
